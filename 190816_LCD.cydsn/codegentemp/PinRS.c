...
{
    uint8 staticBits = (PinRS_DR & (uint8)(~PinRS_MASK));
    PinRS_DR = staticBits | ((uint8)(value << PinRS_SHIFT) & PinRS_MASK);
}
...
{
	CyPins_SetPinDriveMode(PinRS_0, mode);
}
...
{
    return (PinRS_PS & PinRS_MASK) >> PinRS_SHIFT;
}
...
{
    return (PinRS_DR & PinRS_MASK) >> PinRS_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(PinRS_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & PinRS_0_INTR) != 0u) 
		{ 
			 PinRS_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (PinRS_INTSTAT & PinRS_MASK) >> PinRS_SHIFT;
    }
